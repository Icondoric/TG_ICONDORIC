"""
Experience Scorer
Wrapper para calculate_experience_score con extracción desde Gemini
"""

from typing import Dict, List
from app.ml.config.experience_calculator import (
...
def calculate_experience_score_from_cv(
    ...
    Args:
        ...
        min_required_years: Años mínimos requeridos
    ...
    Examples:
        ...
        ...     cv_experience=[
        ...         {'role': 'Developer', 'duration': '2 años'},
    ...
    # Calcular score usando la función logarítmica
