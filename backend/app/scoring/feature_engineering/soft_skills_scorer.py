"""
Soft Skills Scorer
Evalua habilidades blandas usando matching semantico
"""
...
def normalize_soft_skill(skill: str) -> str:
    ...
    # Mapeo de terminos en ingles/espanol
    mappings = {
...
def get_soft_skill_category(skill: str) -> str:
    """
    Clasifica una soft skill en categorias amplias
    Util para matching semantico

    Args:
        skill: Nombre de la soft skill

    Returns:
        Categoria de la skill

    Examples:
        >>> get_soft_skill_category("liderazgo")
        'interpersonal'
        >>> get_soft_skill_category("pensamiento critico")
        'cognitivo'
    """
    ...
    categories = {
        'interpersonal': [
            ...
            'colaboracion', 'empatia', 'inteligencia emocional',
            'resolucion de conflictos', 'persuasion'
        ],
        'cognitivo': [
            'pensamiento critico', 'creatividad', 'resolucion de problemas',
            'toma de decisiones', 'analisis', 'innovacion'
        ],
        'organizacional': [
            'gestion del tiempo', 'planificacion', 'organizacion',
            'priorizacion', 'multitasking'
        ],
        'personal': [
            'adaptabilidad', 'flexibilidad', 'iniciativa',
            'autonomia', 'proactividad', 'resiliencia', 'motivacion'
        ]
    }
...
def calculate_soft_skills_score(
    ...
    """
    Calcula score de soft skills usando matching exacto y por categorias

    Estrategia:
    1. Normalizar soft skills
    2. Matching exacto (Jaccard)
    3. Matching por categorias (si comparten categoria, cuenta parcialmente)
    ...
    Examples:
        ...
        ... )
        {
            ...
            'matched_by_category': ['comunicacion', 'trabajo en equipo'],
    ...
    # Para skills que no hicieron match exacto, ver si comparten categoria
    ...
    # Ratio de skills requeridas cubiertas (exacto + categoria)
    ...
    WEIGHT_CATEGORY = 0.30  # 30% - Match por categoria
