...
/**
 * ReportsView - Fase 7+
 * Vista de analítica y reportes con exportación a PDF y filtros de fecha
 */
...
import SkillsBarChart from '../../components/admin/charts/SkillsBarChart.vue'
...
<template>
    <div class="max-w-7xl mx-auto py-8 px-4">
        ...
        <header class="mb-8 flex flex-col xl:flex-row xl:items-end justify-between gap-6">
            <div>
                <h1 class="text-3xl font-bold text-slate-800">Reportes y Analítica</h1>
        ...
        <div v-if="loading" class="bg-white rounded-xl shadow-md p-12 text-center">
            ...
            <p class="mt-4 text-slate-500">Generando analítica...</p>
        </div>
        ...
        <div v-else id="report-container" class="space-y-8 bg-slate-50 p-4 -mx-4 sm:p-0 sm:mx-0 sm:bg-transparent">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 break-inside-avoid">
                ...
                <!-- User Distribution -->
                <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                    <h3 class="font-semibold text-slate-800 mb-6">Distribución por Rol</h3>
            ...
            <section class="break-before-page">
                <h2 class="text-lg font-semibold text-slate-800 mb-4 px-1 mt-8">Análisis de Talento (IA Extract)</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                        ...
                        <p class="text-xs text-slate-400 mb-6">Las herramientas y tecnologías más frecuentes en perfiles actualizados</p>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                        <h3 class="font-semibold text-slate-800 mb-2 flex items-center gap-2">
                         ...
                         <p class="text-xs text-slate-400 mb-6">Las competencias interpersonales más destacadas</p>
