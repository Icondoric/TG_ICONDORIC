    ...
    <div class="flex">
      ...
      <aside class="hidden lg:block fixed top-16 left-0 w-[280px] h-[calc(100vh-4rem)] bg-white border-r border-gray-200 overflow-y-auto">
        <div class="p-6">
          ...
          <div class="flex justify-center mb-6">
            <Badge :variant="profile.is_complete ? 'gold' : 'danger'">
              {{ profile.is_complete ? 'Perfil Completo' : 'Perfil Incompleto' }}
            </Badge>
          </div>
          ...
          <nav class="space-y-2">
            <a
              href="#competencias"
              class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-emi-navy-50 hover:text-emi-navy-500 rounded-lg transition-colors"
            >
            ...
            >
              ...
              <span class="font-medium">Formacion</span>
            </a>
            <a
              href="#experiencia"
              class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-emi-navy-50 hover:text-emi-navy-500 rounded-lg transition-colors"
          ...
          <div class="mt-6 pt-6 border-t border-gray-200">
            <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4">Resumen</h3>
            <div class="space-y-3">
              <div class="flex justify-between items-center">
                <span class="text-sm text-gray-600">Habilidades Tecnicas</span>
                <Badge variant="navy" size="sm">{{ profile.hard_skills.length }}</Badge>
              </div>
              <div class="flex justify-between items-center">
                <span class="text-sm text-gray-600">Habilidades Blandas</span>
                <Badge variant="gold" size="sm">{{ profile.soft_skills.length }}</Badge>
              </div>
              <div class="flex justify-between items-center">
                <span class="text-sm text-gray-600">Idiomas</span>
                <Badge variant="neutral" size="sm">{{ profile.languages.length }}</Badge>
              </div>
              <div class="flex justify-between items-center">
                <span class="text-sm text-gray-600">Anos de Experiencia</span>
                <Badge variant="navy" size="sm">{{ profile.experience_years }}</Badge>
              </div>
            </div>
          </div>
      ...
      <main class="flex-1 lg:ml-[280px]">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <!-- Header -->
          <div class="mb-8">
            <h1 class="text-3xl font-bold text-emi-navy-500">Mi Perfil Profesional</h1>
