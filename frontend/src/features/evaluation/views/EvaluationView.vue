...
const selectedProfile = computed(() => {
    return profilesStore.activeProfiles.find(p => p.id === selectedProfileId.value)
})
    ...
    <AppLayout>
        <div class="flex">
            ...
            <EvaluationSidebar
                ...
                :profileCount="profilesStore.activeProfiles.length"
                ...
                <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div v-if="step === 1" class="space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-md p-6">
                            ...
                            <div v-if="profilesStore.isLoadingProfiles" class="text-center py-8">
                                <div class="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto"></div>
                                <p class="mt-2 text-slate-500">Cargando instituciones...</p>
                            </div>

                            <div v-else-if="profilesStore.activeProfiles.length === 0" class="text-center py-8">
                                <p class="text-slate-500">No hay perfiles institucionales disponibles</p>
                            </div>

                            <div v-else class="grid gap-4 md:grid-cols-2">
                                <label
                                    v-for="profile in profilesStore.activeProfiles"
                                    :key="profile.id"
                                    :class="[
