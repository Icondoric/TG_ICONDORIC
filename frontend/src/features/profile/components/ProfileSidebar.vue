<template>
  ...
  >
    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden">
      ...
      <!-- Expanded -->
      <div v-show="isExpanded" class="p-4 space-y-6 pt-10" style="width: 280px">
      ...
      <div v-show="!isExpanded" class="flex flex-col items-center pt-12 space-y-6 px-2">
        <div
          class="w-10 h-10 bg-emi-navy-100 rounded-full flex items-center justify-center text-lg font-bold text-emi-navy-600"
          title="Perfil"
        >
