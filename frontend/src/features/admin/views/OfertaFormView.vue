...
const normalizeWeights = () => {
    ...
    // Pasa 1: normalizar con 3 decimales
    let accumulated = 0
    for (let i = 0; i < keys.length; i++) {
        if (i === keys.length - 1) {
            // La ultima clave absorbe el residuo para que la suma sea exactamente 1.0
...
const loadOferta = async () => {
    ...
    try {
        ...
        if (oferta.weights) {
            // Solo asignar las claves conocidas — evita mezclar claves extra del DB (ej. en español)
...
const saveOferta = async () => {
    ...
    error.value = null
    try {
        // Normalizar en el payload para evitar errores de punto flotante
                    ...
                    <div class="space-y-4 lg:sticky lg:top-6 lg:self-start">
                        ...
                        <div class="card-emi p-5">
                            <div class="flex items-center gap-2 mb-4">
                                <div class="w-7 h-7 bg-info-100 rounded-lg flex items-center justify-center shrink-0">
                                    <svg class="w-4 h-4 text-info-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="space-y-8">
                                ...
                                <div class="bg-slate-50 rounded-lg p-3">
                                    ...
                                    <div class="flex gap-1.5 mb-2">
                                        ...
                                        <button type="button" @click="addRequiredSkill"
                                            class="px-2.5 py-1.5 bg-emi-navy-500 text-white text-xs rounded-md hover:bg-emi-navy-600 font-medium transition-colors">
                                            +
                                        </button>
                                    </div>
                                ...
                                <div class="bg-slate-50 rounded-lg p-3">
                                    ...
                                    <div class="flex gap-1.5 mb-2">
                                        ...
                                        <button type="button" @click="addSoftSkill"
                                            class="px-2.5 py-1.5 bg-info-500 text-white text-xs rounded-md hover:bg-info-600 font-medium transition-colors">
                                            +
                                        </button>
                                    </div>
                                    <div class="flex flex-wrap gap-1.5 min-h-6">
                        ...
                        <div class="border-t border-slate-100 pt-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <!-- Rango de semestre (solo para pasantías) -->
                                <div v-if="form.tipo === 'pasantia'">
                                    ...
                                    <p class="mt-1 text-xs text-slate-400">
                                        Ejemplo: "7 hasta —" para desde 7mo semestre sin límite superior.
                                        Titulados ignoran este filtro.
                                    </p>
                                </div>
                        ...
                        <!-- ── 3. Pesos + 4. Umbrales en grid 2 columnas ── -->
                        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 border-t border-slate-100 pt-6">
                            ...
                            <div class="lg:col-span-2">
                                <div class="flex items-center gap-2 mb-1">
                                    <span class="w-6 h-6 rounded-full bg-emi-navy-500 text-white text-xs flex items-center justify-center font-bold shrink-0">4</span>
