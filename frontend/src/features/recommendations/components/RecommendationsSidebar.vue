<template>
  ...
  >
    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden">
      ...
      <!-- Expanded -->
      <div v-show="isExpanded" class="p-6" style="width: 280px">
        ...
        <div v-if="bestMatch" class="text-center mb-6">
          <GaugeChart
            ...
            label="Mejor Match"
          />
          <p class="text-sm text-gray-600 mt-2 truncate" :title="bestMatch.oferta?.titulo">
      ...
      <!-- Collapsed Icons -->
      <div v-show="!isExpanded" class="flex flex-col items-center pt-12 space-y-6 px-2">
          ...
          <div v-if="bestMatch" class="relative w-10 h-10 flex items-center justify-center">
            <svg class="w-full h-full transform -rotate-90">
              ...
              <circle
                cx="20" cy="20" r="16"
                fill="transparent"
                :stroke="bestMatch.match_score >= 0.7 ? '#10b981' : '#f59e0b'"
                stroke-width="4"
                :stroke-dasharray="100"
                :stroke-dashoffset="100 - (bestMatch.match_score * 100)"
              />
            </svg>
